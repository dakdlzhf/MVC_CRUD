...
<body>
	<div class="container">
		...
		<form class="form-horizontal" action="replyProc.do" method="post">
			...
			<input type='hidden' name='memono' value="<%=dto.getMemono()%>"> <input type='hidden' name='grpno' value="<%=dto.getGrpno()%>"> <input type='hidden' name='indent' value="<%=dto.getIndent()%>"> <input type='hidden' name='ansnum' value="<%=dto.getAnsnum()%>">
